...
def validar_diferenciacion(nodo1, nodo2, t1, t2):
    ...
    if nodo1.tipo == Tipos.BOOL:
        match nodo2.tipo:
            ...
            case Tipos.CHAR:
                return Error('semántico', 'No se puede comparar un valor booleano con un carácter', nodo2.linea, nodo2.columna), None
    ...
    if nodo1.tipo == Tipos.CHAR:
        match nodo2.tipo:
            ...
            case Tipos.BOOL:
                return Error('semántico', 'No se puede comparar un valor carácter con un booleano', nodo2.linea, nodo2.columna), None
            # CARACTER != CARACTER = BOOLEANO
            case Tipos.CHAR:
                return t1 != t2, Tipos.BOOL
            # CARACTER != CADENA = ERROR
            case Tipos.STRING:
                return Error('semántico', 'No se puede comparar un valor carácter con una cadena', nodo2.linea, nodo2.columna), None
            case _:
                return Error('semántico', 'Error al comparar la expresión', nodo2.linea, nodo2.columna), None
    ...
    if nodo1.tipo == Tipos.STRING:
        match nodo2.tipo:
            ...
            case Tipos.CHAR:
                return Error('semántico', 'No se puede comparar una cadena con un carácter', nodo2.linea, nodo2.columna), None
